...
return (
 ...
 <p className="Occupationinfo">File size should be 2KB to 2MB only</p>
      <div className="row " >        
        <div className="col-md-5 col-sm-12" >
          <p className="Tabtitle">Selfe Photo</p>
 <FileUploaderwithArrowIcon uploadHandler={uploadHandler} />
        </div>
        <div className="col-md-2 col-sm-hidden" >&nbsp;</div>
        <div className="col-md-5 col-sm-12  " >
        <p className="Tabtitle">Signature</p>
        <FileUploaderwithArrowIcon uploadHandler={uploadHandler} />
        <p className="Occupationinfo">A Sample Image of signature</p>
      </div>
      </div>
